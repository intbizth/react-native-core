...
export default class VideoPlayer extends Component {
    ...
    renderTopControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={require('../../../public/icon/video/top-vignette.png')}
    ...
    renderBack() {
        ...
        return this.renderControl(
            <Image
                source={ require( '../../../public/icon/video/back.png' ) }
    ...
    renderVolume() {
        ...
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../../../public/icon/video/volume.png' ) } />
                </View>
            </View>
        );
    }
    ...
    renderFullscreen() {
        return this.renderControl(
            <Image source={ require( '../../../public/icon/video/expand_ic.png' ) } />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../../public/icon/video/bottom-vignette_ic.png' ) }
                    style={[ styles.controls.column ]}
                    imageStyle={[ styles.controls.vignette ]}>
                    { seekbarControl }
                    <View style={[
     ...
     */
    renderPlayPause() {
        let source = this.state.paused === true ? require( '../../../public/icon/video/play_ic.png' ) : require( '../../../public/icon/video/pause_ic.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../../../public/icon/video/loader_ic.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
        ...
        if ( this.state.error ) {
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( '../../../public/icon/video/error_ic.png' ) } style={ styles.error.icon } />
